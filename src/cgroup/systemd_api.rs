...
pub trait OrgFreedesktopSystemd1Manager {
    ...
    fn enqueue_unit_job(
        ...
        (
            ...
            dbus::Path<'static>,
            String,
            Vec<(u32, dbus::Path<'static>, String, dbus::Path<'static>, String)>,
        ),
        dbus::Error,
    >;
    ...
    fn get_job_after(
        ...
        Vec<(u32, String, String, String, dbus::Path<'static>, dbus::Path<'static>)>,
        dbus::Error,
    >;
    fn get_job_before(
        &self,
...
impl arg::ReadAll for OrgFreedesktopSystemd1ManagerUnitNew {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopSystemd1ManagerUnitNew { id: i.read()?, unit: i.read()? })
    }
}
...
impl arg::ReadAll for OrgFreedesktopSystemd1ManagerUnitRemoved {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopSystemd1ManagerUnitRemoved { id: i.read()?, unit: i.read()? })
    }
}
...
impl arg::ReadAll for OrgFreedesktopSystemd1ManagerJobNew {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopSystemd1ManagerJobNew { id: i.read()?, job: i.read()?, unit: i.read()? })
    }
}
    ...
    OrgFreedesktopSystemd1Manager for blocking::Proxy<'a, C>
{
    ...
    fn get_job_after(
        ...
        dbus::Error,
    > {
        self.method_call("org.freedesktop.systemd1.Manager", "GetJobAfter", (id,)).and_then(
            |r: (Vec<(u32, String, String, String, dbus::Path<'static>, dbus::Path<'static>)>,)| {
                Ok(r.0)
            },
        )
    }
    ...
    fn get_job_before(
        ...
        dbus::Error,
    > {
        self.method_call("org.freedesktop.systemd1.Manager", "GetJobBefore", (id,)).and_then(
            |r: (Vec<(u32, String, String, String, dbus::Path<'static>, dbus::Path<'static>)>,)| {
                Ok(r.0)
            },
        )
    ...
    fn list_units(
        ...
        dbus::Error,
    > {
        self.method_call("org.freedesktop.systemd1.Manager", "ListUnits", ()).and_then(
            |r: (
                Vec<(
                    String,
                    String,
    ...
    fn list_units_by_names(
        ...
        dbus::Error,
    > {
        self.method_call("org.freedesktop.systemd1.Manager", "ListUnitsByNames", (names,)).and_then(
            |r: (
                Vec<(
                    String,
                    String,
    ...
    fn list_jobs(
        ...
        dbus::Error,
    > {
        self.method_call("org.freedesktop.systemd1.Manager", "ListJobs", ()).and_then(
            |r: (Vec<(u32, String, String, String, dbus::Path<'static>, dbus::Path<'static>)>,)| {
                Ok(r.0)
            },
        )
